...
@eqx.filter_jit
def canoak_rsoil_hybrid_each_iteration(
...
def canoak_rsoil_hybrid(
    ...
    finals = fixed_point(
        canoak_rsoil_hybrid_each_iteration, initials, para, niter, *args
    )
...
#     Can,
# ]:
#     print("Compiling canoak_rsoil_hybrid ...")
