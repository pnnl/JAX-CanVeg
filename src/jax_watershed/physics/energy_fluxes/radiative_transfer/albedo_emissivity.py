...
def calculate_ground_albedos(
    f_snow: Float_0D, rad_type: str
    ...
    Returns:
        Tuple[Float_0D, Float_0D]: The overall direct beam and diffuse ground albedos
    """
...
def calculate_ground_vegetation_emissivity(
    ...
    Args:
        ...
        μ_bar (float): The average inverse diffuse optical depth per unit leaf and
                       stem area.
