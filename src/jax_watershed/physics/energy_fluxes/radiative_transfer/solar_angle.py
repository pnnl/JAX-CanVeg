...
def calculate_solar_elevation_Walraven(
    ...
    theta = (360.*time_1980/365.25) * RADD
    g     = -.031272 - 4.53963e-7 * time_1980 + theta
    el    = 4.900968 + 3.6747e-7 * time_1980 + (.033434 - 2.3e-9 * time_1980) * jnp.sin(g) + .000349 * jnp.sin(2. * g) + theta
