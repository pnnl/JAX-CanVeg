...
class TestCanopyTemperature(unittest.TestCase):
    ...
    def test_estimate_canopy_temperature_and_L(self):
        ...
        func = lambda x, args: calculate_canopy_temp_L(x, **args)
        args = dict(S_v=S_v, L_down=L_down, pres=pres, ρ_atm=ρ_atm, T_v_t1=T_v_t1, T_g_t1=T_g_t1, T_g_t2=T_g_t2, 
             T_a_t2=T_a_t2, u_a_t2=u_a_t2, q_a_t2=q_a_t2, q_g_t2=q_g_t2, L=L, S=S, ε_g=ε_g, ε_v=ε_v, 
             z_a=z_a, z0m=z0m, z0c=z0c, d=d, gstomatal=gstomatal, gsoil=gsoil)
