...
class TestGroundTemperature(unittest.TestCase):
    def test_estimate_ground_temperature(self):
        ...
        T_g_t1, T_g_t2 = 10.0 + c2k, 11.0 + c2k
        T_a_t2, u_a_t2, z_a, q_a_t2 = 12.0 + c2k, 4.0, 2.5, 0.015
        T_soil1_t1, dz, κ = 9.0 + c2k, 0.05, 1.0
        ...
        # args = dict(T_s=T_s_t2, q_v_sat=q_v_sat_t2*1e-3, q_s=q_s_t2*1e-3, gh=gvm, ge=gvw, S_v=S_v, L_v=L_v, ρ_atm=ρ_atm)  # noqa: E501
        ...
        # print(ground_energy_balance(T_g=T_g_t2, T_s=T_s_t2, T_s1=T_soil1_t1, κ=κ, dz=dz, q_g=q_g_t2*1e-3, q_s=q_s_t2*1e-3, gh=ggm, ge=ggw, S_g=S_g, L_g=L_g, ρ_atm=ρ_atm))  # noqa: E501
        args = dict(
            T_s=T_s_t2,
            T_s1=T_soil1_t1,
            κ=κ,
        ...
        def func(T_g, args):
            return ground_energy_balance(T_g=T_g, **args)
    ...
    def test_estimate_ground_canopy_temperature_and_L(self):
        ...
        def func(x, args):
            return calculate_ground_canopy_temp_L(x, **args)
    ...
    def test_estimate_L_then_ground_canopy_temperature(self):
        ...
        # Jointly estimate T_v_t2 and L
        def func(x, args):
            return calculate_ground_canopy_temp(x, **args)
