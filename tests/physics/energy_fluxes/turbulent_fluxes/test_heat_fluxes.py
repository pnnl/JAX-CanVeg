...
from jax_watershed.physics.energy_fluxes.turbulent_fluxes import calculate_E, calculate_H
...
class TestHeatFluxes(unittest.TestCase):
    ...
    def test_sensible_heat_flux(self):
        ...
        H = calculate_H(T_2=295, T_1=290, ρ_atm=1.293, gh=1./100.)
    ...
    def test_latent_heat_flux(self):
        ...
        E = calculate_E(q_2=0.01, q_1=0.006, ρ_atm=1.293, ge=1./100.)
        λE = λ * E
